...
SCENARIOS: Dict[str, Scenario] = {
    "spatial_detection": Scenario(
        ...
        action_sequence=[
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.03, "y": 0.31, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.08, "y": 0.42, "z": 0.88}},
        ],
    ),
    "single_grasp": Scenario(
        name="single_grasp",
        description="Pick up the red cube on the reachable table",
        task="Pick up the red cube",
        initial_state={"gripper_open": 1.0, "target_x": 0.04, "target_y": 0.36, "target_z": 0.83},
        initial_gripper={"position": 0.04, "force": 0.0},
        action_sequence=[
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.83}},
            {"action": "grasp", "params": {"arm": "left", "force": 50}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.90}},
        ],
    ),
    "grasp_and_move": Scenario(
        ...
        initial_state={"gripper_open": 1.0, "target_x": 0.45, "target_y": 0.36, "target_z": 0.83},
        initial_gripper={"position": 0.04, "force": 0.0},
        action_sequence=[
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.04, "y": 0.36, "z": 0.83}},
            {"action": "grasp", "params": {"arm": "left", "force": 50}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.30, "y": 0.42, "z": 0.88}},
        ],
    ),
    "error_recovery": Scenario(
        ...
        initial_state={"gripper_open": 1.0, "target_x": 0.03, "target_y": 0.31, "target_z": 0.82},
        initial_gripper={"position": 0.04, "force": 0.0},
        action_sequence=[
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.03, "y": 0.31, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.03, "y": 0.31, "z": 0.84}},
            {"action": "grasp", "params": {"arm": "left", "force": 20}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.03, "y": 0.31, "z": 0.82}},
    ...
    "dynamic_environment": Scenario(
        ...
        initial_state={"gripper_open": 1.0, "target_x": 0.08, "target_y": 0.42, "target_z": 0.82},
        initial_gripper={"position": 0.04, "force": 0.0},
        action_sequence=[
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.08, "y": 0.42, "z": 0.88}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.08, "y": 0.42, "z": 0.83}},
            {"action": "grasp", "params": {"arm": "left", "force": 30}},
            {"action": "move_arm_to", "params": {"arm": "left", "x": 0.10, "y": 0.42, "z": 0.88}},
        ],
    ),
}
