...
class AssemblySkill:
        ...
        **kwargs
        ...
        if self._simulated:
            ...
            path_points = [
                ...
                [target_position[0], target_position[1], clearance_height],  # 平移到目标上方
                [target_position[0], target_position[1], target_position[2] + approach_height],  # 下降到接近位置
                target_position  # 目标位置
            ]
    ...
    async def _align_parts(
        ...
        **kwargs
        ...
        if self._simulated:
            # 获取零件信息
            pa = self._parts_library.get(part_a, AssemblyPart(name=part_a, part_id="", dimensions=[0.1, 0.1, 0.1]))
            pb = self._parts_library.get(part_b, AssemblyPart(name=part_b, part_id="", dimensions=[0.1, 0.1, 0.1]))
