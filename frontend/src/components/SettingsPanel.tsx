...
export const SettingsPanel = () => {
  const {
    language, theme, model, websocketUrl, apiUrl, refreshRate, deepseekApiKey, realModeToken,
    setLanguage, setTheme, setModel, setWebsocketUrl, setApiUrl, setRefreshRate, setDeepseekApiKey, setRealModeToken,
  } = useSettingsStore()
  ...
  return (
    <div className="max-w-xl space-y-6">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Real Mode Token</label>
        <input
          type="password"
          value={realModeToken}
          onChange={(e) => setRealModeToken(e.target.value)}
